...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildBody(BuildContext context, List<DocumentSnapshot<Map<String, dynamic>>> snapshots) {
    List<Movie> movies = snapshots.map((e) => Movie.fromSnapshot(e)).toList();
